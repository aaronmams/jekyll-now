...
{% highlight text %}
##   bweight   mmarried mhisp fhisp foreign alcohol deadkids mage medu fage
## 1    3459    married     0     0       0       0        0   24   14   28
## 2    3260 notmarried     0     0       1       0        0   20   10    0
## 3    3572    married     0     0       1       0        0   22    9   30
## 4    2948    married     0     0       0       0        0   26   12   30
## 5    2410    married     0     0       0       0        0   20   12   21
##   fedu nprenatal monthslb order  msmoke   mbsmoke mrace frace prenatal
## 1   16        10       30     2 0 daily nonsmoker     1     1        1
## 2    0         6       42     3 0 daily nonsmoker     0     0        1
## 3    9        10       17     3 0 daily nonsmoker     1     1        1
## 4   12        10       34     2 0 daily nonsmoker     1     1        1
## 5   14        12        0     1 0 daily nonsmoker     1     1        1
...
![plot of chunk unnamed-chunk-3](/images/treatmenteffects/unnamed-chunk-3-1.png)
...
![plot of chunk unnamed-chunk-5](/images/treatmenteffects/unnamed-chunk-5-1.png)
...
## 
## Call:
## lm(formula = bweight ~ factor(mbsmoke) + ipwra.p, data = pscore.df)
## 
## Residuals:
...
{% highlight text %}
##                                  Estimator TreatmentEffect
## 1                       Difference in POMs        -277.061
## 2          Difference in IP Weighted Means        -275.500
## 3 Regression Adjustment (Propensity Score)        -226.880
{% endhighlight %}
